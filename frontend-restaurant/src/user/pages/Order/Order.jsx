  ...
  const order = async (event) => {
    ...
    Object.values(cartItems).forEach((cartItem) => {
      ...
      if (foodItem) {
        ...
        const normalizedMandatoryOptions =
          typeof cartItem.mandatoryOptions === "object" &&
          !Array.isArray(cartItem.mandatoryOptions)
      ...
      if (method === "pickup") {
        ...
        if (allowedZipCodes.includes(data.zipCode)) {
          if (getTotalCartAmount() < 150) {
            setErrorMessage("❌ Minimum order amount for delivery is NOK 150.");
          } else {
            setErrorMessage("");
            document.querySelector("form").requestSubmit();
          }
          ...
          setErrorMessage(
            "❌ Sorry, we don't deliver to your ZIP code. Please choose pickup."
          );
        }
      }
    ...
    <>
        ...
        <div className="delivery-modal">
          <div className="delivery-modal-content">
            ...
            <div className="options">
              ...
              <button onClick={() => handleDeliveryChoice("delivery")}>
                Delivery
              </button>
            </div>
            <button
      ...
      <form onSubmit={order} className="order">
        ...
        <div className="order-right">
          {errorMessage && (
            <div className="order-error-message">{errorMessage}</div>
          )}
          ...
          <div className="cart-total">
            ...
            <div>
              <div className="cart-total-details">
                <b>Total</b>
                <b>
                  Kr {getTotalCartAmount() === 0 ? 0 : getTotalCartAmount()}
                </b>
              </div>
            </div>
